...
### 8.3 Visual Benchmarks (Validation Phase - 2025)

**Metrics Comparison (Validation)**
This graph compares RMSE, MAE, MAPE, and R2 across all evaluated single architectures. It highlights XGBoost and GRU as leading structural models, with XGBoost achieving an exceptional 94.7% R2 on Consumption predictions.
![](C:/Users/merch/Documents/uni/Sem6/ML/version/Project/validation/01_metrics_comparison.png)

**Per-Hour Error Patterns (Validation)**
This chart displays the average Mean Absolute Percentage Error (MAPE) broken down by the 24 hours of the day. Peak hours (14:00-16:00) demonstrate high predictability (~2.2% error), while morning ramp-ups (05:00-08:00) exhibit higher volatility.
![](C:/Users/merch/Documents/uni/Sem6/ML/version/Project/validation/02_hourly_mape.png)

**Residuals Distribution**
Error histograms and Q-Q plots visualizing prediction errors. Normalizing residual distribution is key to assuring no structural biases exist in the forecasting algorithm.
![](C:/Users/merch/Documents/uni/Sem6/ML/version/Project/validation/03_residuals_distribution.png)

**Binned Accuracy Heatmap (Validation)**
Treats the regression output as classification by grouping predictions into Low, Medium, and High bounds. This heatmap shows the model excels (up to 90.82% accuracy) at securely identifying medium-range consumption.
![](C:/Users/merch/Documents/uni/Sem6/ML/version/Project/validation/04_binned_accuracy_heatmap.png)

**Time Series Overlay (Validation)**
Direct sequence comparison charting predicted matrices versus real ENTSO-E actuals. Highlights the ability to map weekend dips and seasonal consumption drops accurately.
![](C:/Users/merch/Documents/uni/Sem6/ML/version/Project/validation/05_predicted_vs_actual.png)

### 8.4 Visual Benchmarks (Testing Phase - 2026)

**Metrics Comparison (Test Phase)**
Comparative bar chart confirming the Ensemble's superiority over standalone models natively on testing data. The Ensemble achieves the lowest RMSE (1726.51 MW for consumption, 24.34 EUR/MWh for price).
![](C:/Users/merch/Documents/uni/Sem6/ML/version/Project/test_results/test_01_metrics_comparison.png)

**Binned Accuracy Heatmap (Test Phase)**
Evaluates the robustness of categorical bounds forecasting (Low/Medium/High). The ensemble categorizations achieve up to 96.9% accuracy for establishing lower-bound consumption tiers.
![](C:/Users/merch/Documents/uni/Sem6/ML/version/Project/test_results/test_02_binned_accuracy_heatmap.png)

**Per-Hour Error Patterns (Test Phase)**
Maps error variations dynamically on test observations. By averaging XGBoost and GRU, the ensemble distinctly bridges their volatility gaps, producing the most stable continuous error curve across all 24 hours.
![](C:/Users/merch/Documents/uni/Sem6/ML/version/Project/test_results/test_03_hourly_mape.png)

**Ensemble vs Best Base Model**
Time series overlay showcasing the first 500 samples of the test sequence. Crucially visualizes how the Ensemble dynamically smooths extreme stochastic spikes where standalone models either over-predict or under-react.
![](C:/Users/merch/Documents/uni/Sem6/ML/version/Project/test_results/test_04_ensemble_vs_best.png)
